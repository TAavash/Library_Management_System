  ...
  return (
    <div>
      ...
      <div className="min-h-screen h-auto bg-white p-[10px]">
        ...
        <div className="h-auto w-[100%] flex flex-col gap-[10px]">
          <div className="w-full h-[600px] flex flex-col bg-red-300 justify-between p-[10px]">
          ...
          <div className="w-full h-[600px] flex flex-col bg-blue-300 justify-between p-[10px]">
          ...
          <div className="w-full h-[600px] flex flex-col bg-green-300 justify-between p-[10px]">
