...
import { getAllProgramCoordinators } from "../../../../utils/Api";

export const ProgramCoordinators = () => {
  const [allProgramCoordinators, setAllProgramCoordinators] = useState([]);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await getAllProgramCoordinators();
